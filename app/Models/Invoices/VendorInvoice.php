...
class VendorInvoice extends Model
{
	...
	public function vendor_invoice_lines() {
		return $this->hasMany(VendorInvoiceLine::class, 'vendor_invoice_number', 'vendor_invoice_number');
	}
	...
	public function vouchers() {
		return $this->hasMany(InvoiceApprovalJournalVoucher::class, 'vendor_invoice_number', 'vendor_invoice_number');
	}

	public function vouchers_with_trash() {
		return $this->hasMany(InvoiceApprovalJournalVoucher::class, 'vendor_invoice_number', 'vendor_invoice_number')->withTrashed();
	}

	public function invoice_approval_journal() {
		return $this->hasOne(InvoiceApprovalJournal::class, 'vendor_invoice_number', 'vendor_invoice_number')->withTrashed();
	}
	...
	public function checks() {
		return $this->hasMany(Check::class, 'vendor_invoice_number', 'vendor_invoice_number');
	}
	...
	public function generateInvoiceJournal(
		...
		foreach ($lines as $key => $line) {
			...
			$invoice_number = $this->vendor_invoice_number;
