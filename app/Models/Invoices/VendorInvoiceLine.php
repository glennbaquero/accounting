...
class VendorInvoiceLine extends Model
{
	...
	public function vendor_invoice() {
		return $this->belongsTo(VendorInvoice::class, 'vendor_invoice_number', 'vendor_invoice_number')->withTrashed();
	}
	...
	public function renderRestoreUrl() {
		return route('vendor-invoice-lines.restore', $this->id);
	}
	
	public function renderArchiveUrl() {
		return route('vendor-invoice-lines.archive', $this->id);
	}

	public function renderApproveUrl() {
		return route('vendor-invoice-lines.approve', $this->id);
	}

	public function renderRejectUrl() {
		return route('vendor-invoice-lines.reject', $this->id);
	}
