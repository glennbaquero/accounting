...
class PurchaseOrderReturnJournal extends Model
{
    /**
	...
	public function purchase_return_journal_vouchers() 
	{
		return $this->hasMany(PurchaseReturnJournalVoucher::class, 'journal_number', 'journal_number');
	}
	...
	{
		$vouchers = $this->purchase_return_journal_vouchers;
		$data = [];
		...
		foreach ($vouchers as $line) {
			array_push($data, [
				...
				'journal_batch_number' => $line->journal_batch_number,
	...
	public function renderShowUrl() {
        return route('purchase-return-journals.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('purchase-return-journals.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('purchase-return-journals.restore', $this->id);
    }
    
    public function renderCreateLineUrl() {
    	return route('purchase-return-journals.create', $this->id);
    }

    public function renderValidateUrl() {
    	return route('purchase-return-journals.validate', $this->id);
    }
    ...
    public function renderEditUrl() {
    	return route('purchase-return-journals.edit', $this->id);
    }
}
