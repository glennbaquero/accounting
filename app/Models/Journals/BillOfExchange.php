...
{
	// protected $appends = [ 'is_selected', 'updateUrl', 'createLineUrl', 'archiveUrl', 'showUrl', 'restoreUrl', 'totalDebit', 'totalCredit', 'totalBalance' ];
	...
	public function toSearchableArray() {
	    return [
			'id' => $this->id,
	        'bill_exchange_journal_number' => $this->bill_exchange_journal_number,
	...
	public function bill_of_exchange_vouchers() 
	{
		return $this->hasMany(BillOfExchangeVoucher::class, 'bill_exchange_journal_number', 'bill_exchange_journal_number');
	}
	...
	{
		$vouchers = $this->bill_of_exchange_vouchers;
		$data = [];
	...
	public function renderShowUrl() {
        return route('bill-of-exchanges.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('bill-of-exchanges.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('bill-of-exchanges.restore', $this->id);
    }
    
    public function renderEditUrl() {
    	return route('bill-of-exchanges.edit', $this->id);
    }

    public function renderCreateLineUrl() {
    	return route('bill-of-exchanges.create', $this->id);
    }

    public function renderValidateUrl() {
    	return route('bill-of-exchanges.validate', $this->id);
    }
