...
class SalesOrderReturnJournal extends Model
{
    /**
	...
	public function sales_return_journal_vouchers() 
	{
		return $this->hasMany(SalesReturnJournalVoucher::class, 'journal_number', 'journal_number');
	}
	...
	{
		$vouchers = $this->sales_return_journal_vouchers;
		$data = [];
	...
	public function renderShowUrl() {
        return route('sales-return-journals.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('sales-return-journals.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('sales-return-journals.restore', $this->id);
    }

    public function renderCreateLineUrl() {
    	return route('sales-return-journals.create', $this->id);
    }

    public function renderValidateUrl() {
    	return route('sales-return-journals.validate', $this->id);
    }
    ...
    public function renderEditUrl() {
    	return route('sales-return-journals.edit', $this->id);
    }
}
