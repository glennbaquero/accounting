...
class PromissoryNote extends Model
{
	...
	public function toSearchableArray() {
	    return [
			'id' => $this->id,
	        'promissory_note_journal_number' => $this->promissory_note_journal_number,
	...
	public function promissory_note_vouchers() 
	{
		return $this->hasMany(PromissoryNoteVoucher::class, 'promissory_note_journal_number', 'promissory_note_journal_number');
	}
	...
	{
		$vouchers = $this->promissory_note_vouchers;
		$data = [];
		...
		foreach ($vouchers as $line) {
			array_push($data, [
				...
				'pending_vendor_invoice' => $line->pending_vendor_invoice,
	...
	public function renderShowUrl() {
        return route('promissory-notes.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('promissory-notes.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('promissory-notes.restore', $this->id);
    }
    
    public function renderEditUrl() {
    	return route('promissory-notes.edit', $this->id);
    }

    public function renderCreateLineUrl() {
    	return route('promissory-notes.create', $this->id);
    }

    public function renderValidateUrl() {
    	return route('promissory-notes.validate', $this->id);
    }
