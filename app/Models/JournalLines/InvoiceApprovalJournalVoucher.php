...
class InvoiceApprovalJournalVoucher extends Model
{
	...
	public function toSearchableArray() {
	    return [
	        ...
	        'invoice_voucher_number' => $this->invoice_voucher_number,
	...
	{
		return $this->belongsTo(InvoiceApprovalJournal::class, 'invoice_approval_journal_number', 'invoice_approval_journal_number')->withTrashed();
	}
	...
	{
	    return $this->belongsTo(VendorInvoice::class, 'invoice_number', 'vendor_invoice_number');
	}
	
	public function main_account_details() 
	{
		return $this->belongsTo(MainAccount::class, 'main_account');
	}

	public function offset_main_account_details() 
	{
		return $this->belongsTo(MainAccount::class, 'offset_account');
	}
	...
	*/
	...
	public function getUpdateUrlAttribute() {
		return route('po-invoice-approval-journals.voucher-update', $this->id);
	}
}
