...
class GeneralJournalVoucher extends Model
{    
	...
	public function toSearchableArray() {
	    return [
	        ...
	        'general_journal_voucher_number' => $this->general_journal_voucher_number,
	...
	*/
	...
	public function getUpdateUrlAttribute() {
		return route('general-journal.voucher-update', $this->id);
	}
}
