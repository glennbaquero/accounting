...
class CustomerInvoiceApprovalVoucher extends Model
{
	...
	{
	    return $this->hasOne(CustomerInvoiceJournal::class, 'customer_invoice_journal_number', 'customer_invoice_journal_number')->withTrashed();
	}

	public function customer_invoice()
	{
	    return $this->hasOne(CustomerInvoice::class, 'customer_invoice_number', 'customer_invoice_number')->withTrashed();
	}
	...
	*/
	...
	public function getUpdateUrlAttribute() {
		return route('so-invoice-approval-journals.voucher-update', $this->id);
	}
}
