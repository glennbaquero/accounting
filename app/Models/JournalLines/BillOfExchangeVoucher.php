...
class BillOfExchangeVoucher extends Model
{
	...
	{
		return $this->belongsTo(BillOfExchange::class, 'bill_exchange_journal_number', 'bill_exchange_journal_number')->withTrashed();
	}
	...
	*/
	...
	public function getUpdateUrlAttribute() {
		return route('bill-of-exchanges.voucher-update', $this->id);
	}
}
