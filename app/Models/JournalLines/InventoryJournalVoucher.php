...
class InventoryJournalVoucher extends Model
{
	...
	public function toSearchableArray() {
	    return [
	        ...
	        'inventory_voucher_number' => $this->inventory_voucher_number,
	        'inventory_batch_number' => $this->inventory_batch_number,
	...
	public function inventory_journal() 
	{
		return $this->belongsTo(InventoryJournal::class, 'inventory_journal_number', 'inventory_journal_number')->withTrashed();
	}
	...
	*/
	...
	public function getUpdateUrlAttribute() {
		return route('inventory-journals.voucher-update', $this->id);
	}
}
