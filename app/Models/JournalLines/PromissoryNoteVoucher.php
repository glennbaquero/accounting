...
class PromissoryNoteVoucher extends Model
{
	...
	public function promissory_note_journal() 
	{
		return $this->belongsTo(PromissoryNote::class, 'promissory_note_journal_number', 'promissory_note_journal_number')->withTrashed();
	}
	...
	*/
	...
	public function getUpdateUrlAttribute() {
		return route('promissory-notes.voucher-update', $this->id);
	}
}
