...
class TermsOfPaymentCustomer extends Model
{
	protected $casts = [
	...
	public function payment_method() {
		return $this->belongsTo(CustomerPaymentMethod::class, 'payment_method_id', 'id')->withTrashed();
	}
	...
	public function renderShowUrl() {
        return route('term-customers.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('term-customers.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('term-customers.restore', $this->id);
    }
}
