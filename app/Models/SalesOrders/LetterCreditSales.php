...
class LetterCreditSales extends Model
{
    /**
    ...
    public function customer_bank() {
        return $this->belongsTo(CustomerBankAccount::class)->withTrashed();
    }
    ...
    public function renderShowUrl() {
        return route('letter-credit-sales.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('letter-credit-sales.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('letter-credit-sales.restore', $this->id);
    }

    public function renderCloseUrl() {
        return route('letter-credit-sales.close', $this->id);
    }

    public function renderConfirmUrl() {
        return route('letter-credit-sales.confirm', $this->id);
    }
