...
class CustomerPaymentFee extends Model
{
    /**
    ...
    public function renderShowUrl() {
        return route('customer-payment-fees.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('customer-payment-fees.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('customer-payment-fees.restore', $this->id);
    }
}
