...
class CustomerBankAccount extends Model
{
	...
	public function renderShowUrl() {
        return route('customer-bank-accounts.show', $this->id);
    }

    public function renderArchiveUrl() {
        return route('customer-bank-accounts.archive', $this->id);
    }

    public function renderRestoreUrl() {
        return route('customer-bank-accounts.restore', $this->id);
    }
}
