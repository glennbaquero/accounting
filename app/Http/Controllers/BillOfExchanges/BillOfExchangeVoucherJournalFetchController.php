...
class BillOfExchangeVoucherJournalFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new BillOfExchangeVoucher;
    }
    ...
    public function filterQuery($query)
    {
        ...
        if($this->request->filled('id')) {
            $query = $query->where('bill_exchange_journal_number', $this->request->id);
        }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $offset_account = $item->offset_account_ma ? MainAccount::withTrashed()->findOrFail($item->offset_account) : '---';
            ...
            array_push($result, [
                ...
                'invoice_payment_release_date' => $item->invoice_payment_release_date,
                ...
                'offset_account' => $item->offset_account_ma ? $item->offset_account_ma->main_account_name : '---',
                ...
                'cash_discount_date' => $item->cash_discount_date,
