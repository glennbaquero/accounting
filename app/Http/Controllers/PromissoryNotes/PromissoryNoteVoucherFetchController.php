...
class PromissoryNoteVoucherFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new PromissoryNoteVoucher;
    }
    ...
    public function filterQuery($query)
    {
        ...
        if($this->request->filled('id')) {
            $query = $query->where('promissory_note_journal_number', $this->request->id);
        }
