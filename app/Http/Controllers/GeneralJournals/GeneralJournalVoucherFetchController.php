...
class GeneralJournalVoucherFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new GeneralJournalVoucher;
    }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            array_push($result, [
                ...
                'accrual_posting' => $item->accrual_posting->main_account->main_account_name ?? '---',
                'client_id' => $item->client_id,
                'general_journal_voucher_number' => $item->general_journal_voucher_number,
                ...
                'posted_on' =>  $item->posted_on ? Carbon::parse($item->posted_on)->format('m/d/Y') : null,
                ...
                'ledger_line_no' => $item->ledger_line_no ?? '---',
                ...
                'voucher_number' => $item->general_journal_voucher_number,
