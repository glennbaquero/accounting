...
class GeneralJournalFetchController extends Controller
{
    /**
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            array_push($result, [
                ...
                'general_journal_number' => $item->general_journal_number,
                ...
                'totalDebit' => number_format($item->general_journal_vouchers->sum('debit_amount'), 2, '.', ','),
                'totalCredit' => number_format($item->general_journal_vouchers->sum('credit_amount'), 2, '.', ','),
                'totalBalance' => number_format($item->general_journal_vouchers->sum('balance_journal'), 2, '.', ','),
                'total_vouchers' => $item->general_journal_vouchers()->count(),
                'total_log_errors' => $item->general_journal_vouchers()->where('log_message', 'like', '%Error%')->count(),
    ...
    protected function formatView($item)
    {
        ...
        $item->total_logs = $item->general_journal_vouchers()->where('log_message', 'like', '%Error%')->count();
        $item->total_vouchers = $item->general_journal_vouchers()->count();
