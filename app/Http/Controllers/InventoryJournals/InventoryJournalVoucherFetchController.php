...
class InventoryJournalVoucherFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new InventoryJournalVoucher;
    }
    ...
    public function filterQuery($query)
    {
        ...
        if($this->request->filled('id')) {
            $query = $query->where('inventory_journal_number', $this->request->id);
        }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            array_push($result, [
                ...
                'inventory_voucher_number' => $item->inventory_voucher_number,
