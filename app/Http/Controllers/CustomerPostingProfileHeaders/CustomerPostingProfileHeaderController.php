...
namespace App\Http\Controllers\CustomerPostingProfileHeaders;
...
class VendorPostingProfileHeaderController extends Controller
{
    ...
    {
        return view('customer-posting-profile-headers.index', [
    ...
    {
        return view('customer-posting-profile-headers.create', [
            'clients' => User::getClients(),
        ]);
    }
    ...
    {
        $item = CustomerPostingProfileHeader::store($request);
    ...
    public function show($id)
    {
        ...
        return view('customer-posting-profile-headers.show', [
            'item' => $item,
            'clients' => User::getClients(),
        ]);
    }
    ...
    {
        $item = CustomerPostingProfileHeader::withTrashed()->findOrFail($id);
        $message = "You have successfully updated {$item->posting_profile}";

        $item = CustomerPostingProfileHeader::store($request, $item);
     ...
     *
     * @param  \App\CustomerPostingProfileHeader  $sampleItem
     * @return \Illuminate\Http\Response
     */
