...
class VendorInvoiceController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function create($purchase_order_number = null)
    {
    ...
    public function store(VendorInvoiceStoreRequest $request, $purchase_order_number)
    {
        ...
        try {
            ...
            $item = VendorInvoice::store($request);
            ...
            if($vendor_invoice_lines) {
                foreach ($vendor_invoice_lines as $line) {
                    VendorInvoiceLine::create([
                        ...
                        'purchase_order_line_number' => $line['purchase_order_line_number'] ?? null,
     ...
     *
     * @param  \App\VendorInvoice  $sampleItem
     * @return \Illuminate\Http\Response
     */
    ...
    public function update(VendorInvoiceStoreRequest $request, $id)
    {
        ...
        try {
            ...
            $item = VendorInvoice::store($request, $item);
            ...
            if($vendor_invoice_lines) {
                foreach ($vendor_invoice_lines as $line) {
                    if(! isset($line['id'])) {
                        $create = VendorInvoiceLine::create([
                            'vendor_invoice_line_number' => $line['vendor_invoice_line_number'],
                            'purchase_order_line_number' => $line['purchase_order_line_number'] ?? null,
                            'vendor_account' => $item->vendor_account,
                            'receive_now_quantity' => $line['receive_now_quantity'] ?? 0,
                        ...
                        VendorInvoiceLine::findOrFail($line['id'])->update([
                            'vendor_invoice_line_number' => $line['vendor_invoice_line_number'],
                            'purchase_order_line_number' => $line['purchase_order_line_number'] ?? null,
                            'vendor_account' => $item->vendor_account,
                            'receive_now_quantity' => $line['receive_now_quantity'] ?? 0,
    ...
    public function printPDF($id)
    {
        ...
        return view('vendor-invoices.print',[
            'vi' => $vi,
            'vendor' => $vi->vendor,
     ...
     * @return \Illuminate\Http\Response
     */
    public function vendorInvoiceAging()
    {
        return view('vendor-invoices.aging', [
            'clients' => User::getClients()
        ]);
    }
}
