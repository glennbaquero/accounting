...
class BankAccountStatementLineAdjustmentFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new BankAccountStatementLineAdjustment;
    }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $data = array_merge($data, [
                ...
                'approved_by' => $item->renderApprovedBy() ? $item->renderApprovedBy() : null,
    ...
    protected function formatView($item)
    {
        ...
        $item->approved_date = $item->approved_date ? Carbon::parse($item->approved_date)->format('m/d/Y') : '';
