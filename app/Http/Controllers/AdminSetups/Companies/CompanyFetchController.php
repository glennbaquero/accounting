    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $data = array_merge($data, [
                'id' => $item->id,
                'name' => $item->name,
                'department_count' => $item->renderDepartmentCount(),
                'position_count' => $item->renderPositionCount(),
                'user_count' => $item->renderUserCount(),
                'admin' => $item->admin ? $item->admin->renderName() : '---',
