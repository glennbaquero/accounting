...
class PurchaseReturnJournalVoucherFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new PurchaseReturnJournalVoucher;
    }
    ...
    public function filterQuery($query)
    {
        ...
        if($this->request->filled('id')) {
            $query = $query->where('journal_number', $this->request->id);
        }
