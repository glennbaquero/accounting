...
class PurchaseOrderReturnLineFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new PurchaseOrderReturnLine;
    }
    ...
    public function filterQuery($query)
    {
         ...
         * 
         */
        $query = $query->whereHas('purchase_order', function($q) { $q->whereNotNull('confirmed_date'); });
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $data = array_merge($data, [
                'id' => $item->id,
                'purchase_order_number' => $item->purchase_order_return_number,
                'purchase_order_line_number' => $item->return_line_number,
                'vendor' => $item->purchase_order->vendor_name,
                'confirmed_delivery_date' => $item->purchase_order->confirmed_date,
                'order_date' => $item->purchase_order->purchase_order_date,
