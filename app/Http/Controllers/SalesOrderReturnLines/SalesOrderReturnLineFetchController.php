...
class SalesOrderReturnLineFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new SalesOrderReturnLine;
    }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $data = array_merge($data, [
                ...
                'sales_order_return_line_number' => $item->sales_order_return_line_number,
