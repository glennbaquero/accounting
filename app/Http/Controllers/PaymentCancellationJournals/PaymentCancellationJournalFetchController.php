...
class PaymentCancellationJournalFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new PaymentCancellationJournal;
    }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $data = array_merge($data, [
                'id' => $item->id,
                'payment_cancellation_journal_number' => $item->payment_cancellation_journal_number,
