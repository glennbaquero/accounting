...
class PaymentCancellationJournalVoucherFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new PaymentCancellationJournalVoucher;
    }
    ...
    public function fetchView($id = null)
    {
        ...
        $payment_reversals = PaymentReversal::all();
