...
class BankDocumentPostingFetchController extends Controller
{
    /**
    ...
    {
        $this->class = new BankDocumentPosting;
    }
    ...
    public function formatData($items)
    {
        ...
        foreach($items as $item) {
            ...
            $data = array_merge($data, [
                ...
                'facility_group' => $item->facility_group->bank_facility_group_name,
                'facility_type' => $item->facility_type->bank_facility_type_name,
                
                'bank_document_postings' => $item->bank_document_postings,
