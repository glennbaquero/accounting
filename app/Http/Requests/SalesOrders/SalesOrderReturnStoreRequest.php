...
class SalesOrderReturnStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'sales_order_return_number' => $for_updating ? 'unique:sales_order_returns,sales_order_return_number,'.$this->id : 'required|unique:sales_order_returns,sales_order_return_number',
