...
class PurchaseOrderReturnStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'purchase_order_return_number' => $for_updating ? 'unique:purchase_order_returns,purchase_order_return_number,'.$this->id : 'required|unique:purchase_order_returns,purchase_order_return_number',
    ...
    public function messages() {
        return [
            'client_id' => 'client is a required field',
        ];
    }
}
