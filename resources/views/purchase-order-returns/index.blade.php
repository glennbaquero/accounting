...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1> Purchase Order Returns </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Purchase Order Returns</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('purchase-order-returns.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="for_approval">
                            <purchase-order-return-table 
                                :clients="{{ $clients }}"
                                ref="table-1"
                                fetch-url="{{ route('purchase-order-returns.fetch', ['for_confirmation' => 1]) }}"
                            ></purchase-order-return-table>
                        </div>
                        <div class="tab-pane" id="confirmed">
                            <purchase-order-return-table
                                ...
                                ref="table-2"
                                disabled
                                fetch-url="{{ route('purchase-order-returns.fetch', ['confirmed' => 1]) }}"
                            ></purchase-order-return-table>
                        </div>
                        <div class="tab-pane" id="invoiced">
                            <purchase-order-return-table
                                ...
                                ref="table-3"
                                disabled
                                fetch-url="{{ route('purchase-order-returns.fetch', ['invoiced' => 1]) }}"
                            ></purchase-order-return-table>
                        </div>
                    </div>
