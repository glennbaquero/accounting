...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Create Bank Account Statement Line</h1>
            </div>
            <div class="col-sm-6">
    ...
    <section class="content">
        ...
        submit-url="{{ route('bank-account-statement-lines.store', $item->id) }}"
        fetch-url="{{ route('bank-account-statement-lines.fetch-item') }}"
        ></bank-account-statement-line-view>
    </section>
</div>
