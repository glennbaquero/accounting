    ...
    <body>
        ...
        <div class="container">
            <div class="row mt-2">
                ...
                <div class="col-sm-3">
                    <h6>{{ $ci->sales_order_number }}</h6>
                    <h6>{{ \Carbon\Carbon::parse($ci->sales_order->sales_order_date)->format('d/m/Y') }}</h6>
                    <h6>{{ $ci->sales_order_number }}</h6>
                    <h6>{{ \Carbon\Carbon::parse($ci->created_at)->format('d/m/Y') }}</h6>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class='row'>
                        <div class="col-md-12"> {{ $ci->sales_order->delivery_contact }}</div>
                        <div class="col-md-12"> {{ $ci->sales_order->delivery_address }}</div>
                    </div>
                </div>
            </div>
            <hr>
            ...
            <hr>
            <div class="row text-center">
                <div class="col-md-4">{{  \Carbon\Carbon::parse($ci->payment_due_date)->format('d/m/Y') }}</div>
            </div>
            <hr>
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-1">
                    <h6>+ {{ $ci->renderCOP() }}</h6>
                    <h6>- {{ $ci->renderTotalDiscount() }}</h6>
                    <h6>+ {{ $ci->renderSubtotal() }}</h6>
                    <hr>
                    <h6>{{ $ci->renderTotalAmount() }}</h6>
                </div>
            </div>
        </div>
    </div>
