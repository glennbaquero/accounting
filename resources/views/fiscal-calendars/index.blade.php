...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Fiscal calendar</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('fiscal-calendars.create') }}" class="btn btn-primary text-white">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <fiscal-calendar-table 
                                fetch-url="{{ route('fiscal-calendars.fetch') }}"
                                ref="table-1"
                            ></fiscal-calendar-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <fiscal-calendar-table 
                                fetch-url="{{ route('fiscal-calendars.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></fiscal-calendar-table>
                        </div>
