...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('vendor-invoices.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="for_approval">
                            ...
                            :clients="{{ $clients }}"
                            ref="table-1"
                            fetch-url="{{ route('vendor-invoices.fetch',  ['for_approval' => 1 ]) }}"
                            ></vendor-invoice-table>
                        </div>
                        <div class="tab-pane" id="approved">
                            ...
                            :clients="{{ $clients }}"
                            ref="table-2"
                            fetch-url="{{ route('vendor-invoices.fetch',  ['approved' => 1 ] ) }}"
                            ></vendor-invoice-table>
                        </div>
                        <div class="tab-pane" id="posted">
                            ...
                            :clients="{{ $clients }}"
                            ref="table-3"
                            fetch-url="{{ route('vendor-invoices.fetch',  ['posted' => 1 ] ) }}"
                            ></vendor-invoice-table>
                        </div>
                    </div>
                </div>
