        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Fiscal Periods</a></li>
                </ol>
            </div>
        </div>
    </section>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <fiscal-periods-table 
                                fetch-url="{{ route('fiscal-periods.fetch') }}"
                                ref="table-1"
                            ></fiscal-periods-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <fiscal-periods-table 
                                fetch-url="{{ route('fiscal-periods.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></fiscal-periods-table>
                        </div>
