...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Main Accounts</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('main-accounts.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <main-account-table 
                                fetch-url="{{ route('main-accounts.fetch') }}"
                                ref="table-1"
                            ></main-account-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <main-account-table 
                                fetch-url="{{ route('main-accounts.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></main-account-table>
                        </div>
