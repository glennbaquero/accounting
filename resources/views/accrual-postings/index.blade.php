...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Accrual Postings</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Accrual Postings</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('accrual-postings.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <accrual-posting-table
                            ref="table-1"
                            fetch-url="{{ route('accrual-postings.fetch') }}"
                            ></accrual-posting-table>
                        </div>
                        ...
                        <div class="tab-pane show" id="archived">
                            <accrual-posting-table
                            ref="table-2"
                            fetch-url="{{ route('accrual-postings.fetch', ['archived' => 1]) }}"
                            ></accrual-posting-table>
                        </div>
                    </div>
                </div>
