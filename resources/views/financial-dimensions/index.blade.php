...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Financial dimensions</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('financial-dimensions.create') }}" class="btn btn-primary text-white">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <financial-dimension-table 
                                fetch-url="{{ route('financial-dimensions.fetch') }}"
                                ref="table-1"
                            ></financial-dimension-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <financial-dimension-table 
                                fetch-url="{{ route('financial-dimensions.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></financial-dimension-table>
                        </div>
