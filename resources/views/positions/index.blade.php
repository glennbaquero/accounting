...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('positions.create', ['company' => $company ]) }}" class="btn btn-primary text-white">
        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-body">
                    <position-table 
                        company="{{ $company }}"
                        fetch-url="{{ route('positions.fetch', ['company' => $company]) }}"
                    ></position-table>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="archived">
                            <position-table 
                                company="{{ $company }}"
                                fetch-url="{{ route('positions.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></position-table>
                        </div>
