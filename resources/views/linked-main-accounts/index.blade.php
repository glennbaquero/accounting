...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Linked Main Account</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('linked-main-accounts.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <link-main-account-table 
                                fetch-url="{{ route('linked-main-accounts.fetch') }}"
                                ref="table-1"
                            ></link-main-account-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <link-main-account-table 
                                fetch-url="{{ route('linked-main-accounts.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></link-main-account-table>
                        </div>
