...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Payment Methods</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('payment-methods.create') }}" class="btn btn-primary text-white">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <payment-method-table 
                                fetch-url="{{ route('payment-methods.fetch') }}"
                                ref="table-1"
                            ></payment-method-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <payment-method-table 
                                fetch-url="{{ route('payment-methods.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></payment-method-table>
                        </div>
