...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Purchase Orders</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('purchase-orders.create') }}" class="btn btn-primary text-white">
            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item"><a @click="initList('table-4')" class="nav-link" href="#archive" data-toggle="tab">Archive</a></li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="for_approval">
                            <purchase-order-table 
                                :clients="{{ $clients }}"
                                ref="table-1"
                                fetch-url="{{ route('purchase-orders.fetch', ['for_confirmation' => 1]) }}"
                            ></purchase-order-table>
                        </div>
                        <div class="tab-pane" id="confirmed">
                            <purchase-order-table
                                ...
                                ref="table-2"
                                disabled
                                fetch-url="{{ route('purchase-orders.fetch', ['confirmed' => 1]) }}"
                            ></purchase-order-table>
                        </div>
                        <div class="tab-pane" id="invoiced">
                            <purchase-order-table
                                ...
                                ref="table-3"
                                disabled
                                fetch-url="{{ route('purchase-orders.fetch', ['invoiced' => 1]) }}"
                            ></purchase-order-table>
                        </div>
                        <div class="tab-pane" id="archive">
                            <purchase-order-table
                                ...
                                ref="table-3"
                                disabled
                                fetch-url="{{ route('purchase-orders.fetch-archive') }}"
                            ></purchase-order-table>
                        </div>
                    </div>
                </div>
