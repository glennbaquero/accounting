...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('inventory-on-hands.create') }}" class="btn btn-primary text-white">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <inventory-on-hand-table 
                                fetch-url="{{ route('inventory-on-hands.fetch') }}"
                                ref="table-1"
                            ></inventory-on-hand-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <inventory-on-hand-table 
                                fetch-url="{{ route('inventory-on-hands.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></inventory-on-hand-table>
                        </div>
