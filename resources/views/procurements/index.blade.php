...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Procurements</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('procurements.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <procurement-table 
                                fetch-url="{{ route('procurements.fetch') }}"
                                ref="table-1"
                            ></procurement-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <procurement-table 
                                fetch-url="{{ route('procurements.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></procurement-table>
                        </div>
