...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('departments.create', ['company' => $company ]) }}" class="btn btn-primary text-white">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <department-table 
                                company="{{ $company }}"
                                ref="table-1"
                                fetch-url="{{ route('departments.fetch', ['company' => $company]) }}"
                            ></department-table>
                        </div>
                        ...
                        <div class="tab-pane" id="archived">
                            ...
                            company="{{ $company }}"
                            ref="table-2"
                            fetch-url="{{ route('departments.fetch-archive') }}"
                            ></department-table>
                        </div>
                    </div>
                </div>
