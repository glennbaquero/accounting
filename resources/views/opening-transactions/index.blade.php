...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Opening Transactions</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Opening Transactions</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('opening-transactions.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            ...
                            ref="table-1"
                            fetch-url="{{ route('opening-transactions.fetch') }}"
                            ></opening-transaction-table>
                        </div>
                        ...
                        <div class="tab-pane show" id="archived">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('opening-transactions.fetch-archive') }}"
                            ></opening-transaction-table>
                        </div>
                    </div>
                </div>
