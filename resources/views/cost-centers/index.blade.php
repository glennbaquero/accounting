...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Cost centers</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('cost-centers.create') }}" class="btn btn-primary text-white">
        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-body">
                    <cost-center-table 
                        fetch-url="{{ route('cost-centers.fetch') }}"
                    ></cost-center-table>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="archived">
                            <cost-center-table  
                                fetch-url="{{ route('cost-centers.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></cost-center-table >
                        </div>
