...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Payment Days</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('payment-days.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <payment-day-table 
                                fetch-url="{{ route('payment-days.fetch') }}"
                                ref="table-1"
                            ></payment-day-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <payment-day-table 
                                fetch-url="{{ route('payment-days.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></payment-day-table>
                        </div>
