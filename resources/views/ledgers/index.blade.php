...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Ledger</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('ledgers.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <ledger-table 
                                fetch-url="{{ route('ledgers.fetch') }}"
                                ref="table-1"
                            ></ledger-table>
                        </div>
                        <div class="tab-pane" id="archived">
                            <ledger-table 
                                fetch-url="{{ route('ledgers.fetch-archive') }}"
                                ref="table-2"
                                disabled
                            ></ledger-table>
                        </div>
