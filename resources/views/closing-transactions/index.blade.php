...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Closing Transactions</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Closing Transactions</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('closing-transactions.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="active">
                            <opening-transaction-table
                            ref="table-1"
                            fetch-url="{{ route('closing-transactions.fetch') }}"
                            ></opening-transaction-table>
                        </div>
                        ...
                        <div class="tab-pane show" id="archived">
                            <opening-transaction-table
                            ref="table-2"
                            fetch-url="{{ route('closing-transactions.fetch-archive') }}"
                            disabled
                            ></opening-transaction-table>
                        </div>
                    </div>
