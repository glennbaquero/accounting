...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Vendor Payments</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        <div class="mb-4">
            <a href="{{ route('vendor-payments.create') }}" class="btn btn-primary text-white">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="for_approval">
                            <vendor-payment-table 
                                :clients="{{ $clients }}"
                                ref="table-1"
                                fetch-url="{{ route('vendor-payments.fetch',  ['pending' => 0 ]) }}"
                            ></vendor-payment-table>
                        </div>
                        <div class="tab-pane" id="approved">
                            <vendor-payment-table 
                                :clients="{{ $clients }}"
                                ref="table-2"
                                fetch-url="{{ route('vendor-payments.fetch',  ['approved_payment' => 1 ] ) }}"
                                :is-approved="true"
                            ></vendor-payment-table>
                        </div>
                        <div class="tab-pane" id="posted">
                            <vendor-payment-table 
                                :clients="{{ $clients }}"
                                ref="table-3"
                                fetch-url="{{ route('vendor-payments.fetch',  ['posted_payment' => 1 ] ) }}"
                                :is-posted="true"
                            ></vendor-payment-table>
                        </div>
                    </div>
