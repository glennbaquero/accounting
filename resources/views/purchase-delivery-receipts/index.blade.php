...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1> Purchase Delivery Receipts </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Purchase Delivery Receipts</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="mb-4">
            <a href="{{ route('purchase-delivery-receipts.create') }}" class="btn btn-primary text-white">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="for_approval">
                            <purchase-delivery-receipt-table 
                            :clients="{{ $clients }}"
                            ref="table-1"
                            fetch-url="{{ route('purchase-delivery-receipts.fetch',  ['for_approval' => 1 ]) }}"
                            ></purchase-delivery-receipt-table>
                        </div>
                        <div class="tab-pane" id="approved">
                            ...
                            ref="table-2"
                            disabled
                            fetch-url="{{ route('purchase-delivery-receipts.fetch',  ['approved' => 1 ] ) }}"
                            ></purchase-delivery-receipt-table>
                        </div>
                        <div class="tab-pane" id="posted">
                            ...
                            ref="table-3"
                            disabled
                            fetch-url="{{ route('purchase-delivery-receipts.fetch',  ['posted' => 1 ] ) }}"
                            ></purchase-delivery-receipt-table>
                        </div>
                    </div>
                </div>
