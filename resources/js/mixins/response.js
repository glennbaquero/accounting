    ...
    methods: {
                ...
                if(type == 'error' || type == 'warning') {
                    switch(result.response.status) {
                        ...
                        case 422:
                            ...
                            break;
                        case 500: message = 'Server Error - Something went wrong!';
                            break;
                    }
                }
            }
        ...
        runToastr(message, title, type, options, hasMultiError) {
            return new Promise((resolve, reject) => {
                ...
                /* Build options */
                let toastrOptionError = {
                    allowHtml: hasMultiError,
                    toastClass: 'toastr',
                    positionClass: "toast-top-left mt-2",
                    progressBar: true,
                    closeButton: true,
                ...
                switch(type) {
                    case 'error': toastr.error(message, title, toastrOptionError); break;
