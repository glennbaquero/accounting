<template>
    <div>
        <div class="table-responsive">
            <table :id="dataTableId" class="table table-hover table-bordered text-center" :class="striped ? 'table-striped' : ''" style="white-space: nowrap">
                <thead>
                    <tr>
        ...
        <div v-if="items.length >= limit">
            <ul class="pagination justify-content-end mt-2">
                ...
                <li class="page-item"  :key="'page' + key" v-for="(data,key) in chunk_data" :class="(key+1) === (current_page+1) ? 'active' : ''">
