                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <h4><i class="fas fa-info-circle"></i> Voucher Header Details</h4><hr>
                                </div>
                                <div class="form-group col-md-12">
                        ...
                        <div class="col-md-2">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>Payment Status <b class="text-danger">*</b></label>
                                    <select class="form-control" v-model="item.payment_status" name="payment_status">
                                        <option value="None">None</option>
                                ...
                                <div class="form-group col-md-12">
                                    <label>Post Dated Check Status <b class="text-danger">*</b></label>
                                    <select class="form-control" v-model="item.postdated_check_status" name="postdated_check_status">
                        ...
                        <div class="col-md-3">
                            <div class="form-group col-md-12">
                                <h4><i class="fas fa-info-circle"></i>Tax & Fee</h4><hr>
                            </div>
                          <!--   <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                <label>Withholding Tax Group <b class="text-danger">*</b></label>
                                <input type="text" class="form-control" v-model="item.withholding_tax_group" name="withholding_tax_group">
                            </div>
                            <div class="form-group col-md-12">
                                <h4><i class="fas fa-info-circle"></i> Fee</h4><hr>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                <label>Fee ID <b class="text-danger">*</b></label>
                                <input type="text" class="form-control" v-model="item.fee_id" name="fee_id">
                            </div>
                            <div class="form-group col-md-12">
                                <label>Fee Amount <b class="text-danger">*</b></label>
                                <input type="text" class="form-control" v-model="item.fee_amount" name="fee_amount">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
	...
	export default {
        ...
        //         return _.filter(this.main_accounts, { 'client_id': client_id })
        //     }
        // },
