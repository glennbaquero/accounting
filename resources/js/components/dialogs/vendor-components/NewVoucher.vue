                        ...
                        <div class="col-md-2">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <v-select
                                        ...
                                        :reduce="item => item[customerOrVendorValue]"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control calendar-form" id="due_date" v-model="item.due_date" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <v-select v-model="item.method_of_payment" label="name" :reduce="item => item.id" placeholder="Select Payment Method" :options="payment_methods" ></v-select>
                                </div>
                                <div class="form-group col-md-12">
	...
	export default {
        ...
        mounted() {
            if(this.clientId) {
                ...
                this.client_main_accounts = this.main_accounts.filter(item => item.client_id === this.clientId);
            }
        },
        ...
        watch: {
            ...
            'main_accounts'() {
                this.client_main_accounts = _.filter(this.main_accounts, { 'client_id': this.item.client_id })
            }
        },
        ...
        methods: {
            ...
            generateLineCode() {
                ...
                this.item[this.voucherIdentification] = (date.getMonth() + 1).toString() + date.getFullYear().toString() +'-'+ time.toString();
