        ...
        >
            ...
            <template v-slot:body="{ items }">
                <tr v-for="item in items">
                    <td>{{ item.purchase_order_return_number }}</td>
                    ...
                    <td>
                        ...
                        :message="'Are you sure you want to archive purchase order #' + item.purchase_order_return_number + '?'"
                        :alt-message="'Are you sure you want to restore purchase order #' + item.purchase_order_return_number + '?'"
                        @load="load"
                        @success="sync"
                        ></action-button>
                    </td>
...
<script>
	...
	export default {
		...
		computed: {
			headers() {
                let array = [
                    { text: 'PO number', value: 'purchase_order_return_number' },
