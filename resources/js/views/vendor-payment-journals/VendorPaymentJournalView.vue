	...
	<div>
		<form-request :submit-url="submitUrl" @load="load" @success="fetchData" confirm-dialog sync-on-success>
				        ...
				        <div class="tab-content">
				        	...
				        	<div class="tab-pane" id="journal-header">
				        		<journal-header
						            ...
						            invoice-header-title="Vendor Payment Journal Number"
			...
			<new-voucher
			    ...
			    journal-identification="vendor_payment_journal_number"
			    deposit-type="deposit_slip_number"
			    due-date-column-name="payment_due_date"
			    :main_accounts="main_accounts"
			    :clients="clients"
			    :invoices="invoices"
			    invoice_number="vendor_payment_number"
	...
	export default {
        ...
        computed: {
            ...
            payment_fields() {
            	...
            	let array = [
            	    ...
            	    { label: 'Method of payment', value: this.selected.method_of_payment, editable: true, model: 'method_of_payment', isDropdownSelection: true, opt_value: 'id', selections: this.payment_methods, display: 'method_of_payment' },
            	    ...
            	    { label: 'Bank Account', value: this.selected.bank_account, editable: true, model: 'bank_account', isDropdownSelection: true, opt_value: 'bank_account', selections: this.client_banks, value: 'bank_account', display: 'bank_name' },
		...
		methods: {
			fetchSuccess(data) {
				...
				this.checker('Vendor Payment Journal', this.journalItem.vendor_payment_journal_number)
