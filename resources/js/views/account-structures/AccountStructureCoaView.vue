			...
			<card>		
				<div class="card card-default">
			        <div class="card-header">
				        <h3 class="card-title"><b>Chart Of Account - Account Structure</b></h3>
				    ...
				    <div class="card-body">
						...
						<div class="row">
			    			<div class="form-group col-sm-6">
			    				<label>Ledger</label>
									<model-list-select :list="ledgers"
									class="form-control"
									label=""		
									name="ledger_id"					
			    			...
			    			<div class="form-group col-sm-6">
									...
									<input type="text" name="company_name" v-model="ledger.company_name" class="form-control" readonly>	
			    			</div>				    			

				    		<div class="form-group col-sm-4">
				    			<label>Chart Of Account Id</label>
				                <input name="chart_of_accounts_id" v-model="coaId.coa_id" class="form-control"readonly >
				            </div>
				    		<div class="form-group col-sm-4">
				    			<label>Chart Of Account Code</label>
				                <input name="ledger_chart_of_accounts" v-model="coaId.coa_code" class="form-control"readonly >
				            </div>
				    		<div class="form-group col-sm-4">
				    			<label>Chart Of Account Name</label>
				                <input name="ledger_chart_of_accounts" v-model="coaId.coa_name" class="form-control"readonly >
				            </div>				            
