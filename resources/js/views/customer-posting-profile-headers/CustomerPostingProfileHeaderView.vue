			...
			<div class="card">
				<div class="card-header">						
					<ul class="nav nav-pills">
						<li class="nav-item"><a class="nav-link active" href="#customer_posting_profile_header" data-toggle="tab">
						Customer Posting Profile Header</a></li>
						<li class="nav-item" v-show="item.id"><a class="nav-link" @click="initList('table-1')" href="#customer_posting_profile_lines" data-toggle="tab">
						Customer Posting Profile Lines</a></li>
					</ul>
				</div>
				<div class="card-body">
					<div class="tab-content">
						<div class="tab-pane show active" id="customer_posting_profile_header">
							<div class="row">
								...
								<div class="form-group col-sm-4">
									<label>
									Customer Posting Profile</label>
