				        		...
				        		<div class="row">
				        			<div class="col-md-4">
			        		    		...
			        		    		<div class="form-group">
											...
											<v-select ref="client_select" disabled v-model="vendor.client_id" :reduce="item => item.id" label="name" placeholder="Select Client" :options="clients"></v-select>
			        		    		</div>

										<div class="form-group mb-2">
			        		    			<label>Vendor Account <b class="text-danger">*</b></label>
											<input type="text" class="form-control" :value="vendor.vendor_account" readonly>
										</div>
...
<script>
	...
	export default {
		...
		computed: {
			submitParams() {
				let item = this.item;
				item.vendor_account = this.vendor.vendor_account;
				item.client_id = this.vendor.client_id;
				// item.bank_account = this.vendor.bank_account;
