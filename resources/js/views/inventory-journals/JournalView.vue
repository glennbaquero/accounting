	...
	<div>
		<form-request :submit-url="submitUrl" @load="load" @success="fetchData" confirm-dialog sync-on-success>
				...
				<div class="row">
					<div class="col-md-3 row">
						...
						<div class="col-md-12 mb-2">
							<label>Journal</label>
							<input type="text" name="balance_journal" :value="balanceJournal" class="form-control" disabled>
						</div>
						<div class="col-md-12 mb-2">
							<label>Per voucher</label>
							<input type="text" name="" :value="balancePerVoucher" class="form-control" disabled>
						</div>
					</div>
					<div class="col-md-3 row">
						<div class="col-md-12 mb-2">
						...
						<div class="col-md-12 mb-2">
							<label>Journal</label> 
							<input type="text" name="total_debit_journal" value="0.00"  :value="debitJournal" class="form-control" disabled>
						</div>
						<div class="col-md-12 mb-2">
							<label>Per voucher</label>
							<input type="text" name="" value="0.00" :value="debitPerVoucher" class="form-control" disabled>
						</div>
					</div>
					<div class="col-md-3 row">
						<div class="col-md-12 mb-2">
						...
						<div class="col-md-12 mb-2">
							<label>Journal</label>
							<input type="text" name="total_credit_journal" value="0.00" :value="creditJournal" class="form-control" disabled>
						</div>
						<div class="col-md-12 mb-2">
							<label>Per voucher</label>
							<input type="text" name="" value="0.00" :value="creditPerVoucher" class="form-control" disabled>
						</div>
					</div>
					    			    ...
					    			    >
					    			    	...
					    			    	<template v-slot:body="{ items }">
					    			    		<tr v-for="$item in items" @click="selectedLine($item)" :class="$item.selected ? 'selected-table' : ''">
					    			    		    ...
					    			    		    <td>{{ $item.inventory_voucher_number }}</td>
			...
			<new-voucher
			    ...
			    voucher-identification="inventory_voucher_number"
			    journal-identification="inventory_journal_number"
	...
	export default {
        ...
        computed: {
            headers() {
                let array = [
                    ...
                    { text: 'Voucher', value: 'inventory_voucher_number' },
            ...
            voucher_fields() {
            	...
            	let array = [
            	    { label: 'Voucher', value: this.selected.inventory_voucher_number, editable: false, model: 'inventory_voucher_number' },
		...
		methods: {
			...
			fetchSuccess(data) {
				...
				this.checker('Inventory Journal', this.journalItem.inventory_journal_number)
