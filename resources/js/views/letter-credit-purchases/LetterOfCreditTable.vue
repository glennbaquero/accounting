        ...
        >
            ...
            <template v-slot:body="{ items }">
                <tr v-for="item in items">
                    ...
                    <td>{{ item.bank_document_number }}</td>
                    <td>{{ item.application_date }}</td>
                    <td>{{ item.receipt_date }}</td>
                    <td>{{ item.amendment_number }}</td>
                    <td>{{ item.amendment_on }}</td>
                    <td>{{ item.amendment_by }}</td>
...
<script>
	...
	export default {
		...
		computed: {
			headers() {
                let array = [
                    { text: 'Purchase Order', value: 'purchase_order_number' },
                    { text: 'Bank Document Number', value: 'bank_document_number' },
                    { text: 'Application Date', value: 'application_date' },
                    { text: 'Receipt Date', value: 'receipt_date' },
                    { text: 'Amendment Number', value: 'amendment_number' },
                    { text: 'Amendment Date', value: 'amendment_on' },
                    { text: 'Amendment By', value: 'amendment_by' },
                    { text: 'Purchase Status', value: 'purchase_status' },
                    { text: 'Closed Date', value: 'close' },
                    { text: 'Confirmed Date', value: 'confirmed' },
                ];
