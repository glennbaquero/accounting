        ...
        >
            ...
            <template v-slot:body="{ items }">
                <tr v-for="item in items">
                    <td>{{ item.payment_cancellation_journal_number }}</td>
                    ...
                    <td>
                        ...
                        :message="`Are you sure you want to archive ${item.payment_cancellation_journal_number}?`"
                        :alt-message="`Are you sure you want to restore ${item.payment_cancellation_journal_number}?`"
                        @load="load"
                        @success="sync"
                        ></action-button>
                    </td>
...
<script>
	...
	export default {
		...
		computed: {
			headers() {
                let array = [
                    { text: 'Bank Reconciliation Journal number', value:'payment_cancellation_journal_number' },
