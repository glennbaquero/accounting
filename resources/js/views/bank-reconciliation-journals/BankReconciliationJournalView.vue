					    			...
					    			<div class="col-md-3">
					    				<div class="row">
								            ...
								            <div class="col-sm-12 mb-2">
								                <label>Bank Reconciliation Journal Number</label>
								                <input readonly type="text" class="form-control" name="bank_reconciliation_journal_number" :value="item.bank_reconciliation_journal_number">
								            </div>
								            <div class="col-sm-12 mb-2">
								                <label>Journal Batch #</label>
								                <input  type="text" class="form-control" name="journal_batch_number" v-model="item.journal_batch_number">
								            </div>
								            <div class="col-sm-12 mb-2">
								            ...
								            <div class="col-sm-12 mb-2">
								                ...
								                <select class="form-control" name="recon_status" v-model="item.recon_status">
					    			...
					    			<div class="col-md-3">
					    				<div class="row">
								            ...
								            <div class="col-sm-12 mb-2">
								                ...
								                <input type="number" class="form-control" name="balance_journal" v-model="item.balance_journal">
								            </div>
								            <div class="col-sm-12 mb-2">
								                <label>(Total debit) Journal</label>
								                <input type="number" class="form-control" name="total_debit_journal" v-model="item.total_debit_journal">
								            </div>
								            <div class="col-sm-12 mb-2">
								                <label>(Total credit) Journal</label>
								                <input type="number" class="form-control" name="total_credit_journal" v-model="item.total_credit_journal">
								            </div>
					    				</div>
					    			...
					    			<div class="col-md-3">
					    				<div class="row">
		    					            ...
		    					            <div class="col-sm-12 mb-2">
		    					                ...
		    					                <input type="text" class="form-control" name="approved_by" v-model="item.approved_by" disabled>
		    					            </div>
		    					            <div class="col-sm-12 mb-2">
		    					            ...
		    					            <div class="col-sm-12 mb-2">
		    					                ...
		    					                <input type="text" class="form-control" name="rejected_by" v-model="item.rejected_by" disabled>
		    					            </div>
		    					            <div class="col-sm-12 mb-2">
		    					                <label>Posted</label>
												<div class="custom-control custom-switch mb-3 mt-2">
					    			...
					    			<div class="col-md-4">
					    				<div class="row">
					            			...
					            			<div class="col-md-12">
												...
												<v-select v-model="item.document" :reduce="item => item.bank_reconciliation_id" label="bank_reconciliation_id" :options="reconciliations" placeholder="Select a document"></v-select>
												<input name="document" hidden v-model="item.document"> 
											</div>
					    				</div>
					    			</div>
					    			<div class="col-md-4">
	...
	export default {
		...
		methods: {
			...
			fetchSuccess(data) {
				...
				this.reconciliations = data.reconciliations ? data.reconciliations : this.reconciliations;
				
				// this.generateVoucherNumber();
				this.checker('Bank Reconciliation Journal', this.item.bank_reconciliation_journal_number);
