						...
						<div class="row">
							<div class="col-md-9">
								<ul class="nav nav-pills">
									<li class="nav-item"><a class="nav-link active" @click="currentTab = 'bank_reconciliation_line'" href="#bank_reconciliation_line" data-toggle="tab">Bank Reconciliation Journal Voucher</a></li>
				        		...
				        		<div class="row">
									<div class="col-md-4">
										<div class="form-group">
                                            ...
                                            <input ref="voucher_number" type="text" class="form-control" id="voucher_number" name="voucher_number" v-model="item.voucher_number">
										</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<h4><i class="fas fa-equals"></i> Bank Reconciliation</h4><hr>
										</div>
	...
	export default {
		...
		methods: {
			...
			generateID() {
				...
				this.item.voucher_number = date.getDate().toString() + date.getMonth().toString() + date.getFullYear().toString() +'-'+ time.toString();
				this.item.voucher_number += "-" + Math.random().toString(36).substring(2, 6);
			}
		},
