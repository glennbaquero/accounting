                            ...
                            <div class="tab-pane show active" id="active">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="bank_facility_group_code">Bank Facility Group Code</label>
                                        <input type="text" class="form-control" name="bank_facility_group_code" v-model="item.bank_facility_group_code">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="bank_facility_group_name">Bank Facility Group Name</label>
                                        <input type="number" min="0" step="any" name="bank_facility_group_name" class="form-control" v-model="item.bank_facility_group_name">
                                    </div>
                                </div>
                                <div class="row">
                                    <text-editor
