        ...
        >
            ...
            <template v-slot:body="{ items }">
                <tr v-for="item in items">
                    <td>{{ item.bank_facility_group_code }}</td>
                    <td>{{ item.bank_facility_group_name }}</td>
...
<script>
	...
	export default {
		...
		computed: {
			headers() {
                let array = [
                    { text: 'Bank Facility Group Code', value: 'bank_facility_group_code' },
                    { text: 'Bank Facility Group Name', value: 'bank_facility_group_name' },
                ];
