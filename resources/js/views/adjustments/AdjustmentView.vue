                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#active" data-toggle="tab">Adjustment</a></li>
                            ...
                            <div class="tab-pane show active" id="active">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" v-model="item.adjustment_number">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="">Adjustment By</label>
                                        <model-list-select :list="users"
                                            v-model="item.adjustment_by"
                                            option-value="id"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input ref="adjustment_date" type="text" class="form-control calendar-form" name="adjustment_date" v-model="item.adjustment_date" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
