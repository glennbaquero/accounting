		...
		<form-request :submit-url="submitUrl" @load="load" @success="fetchData" confirm-dialog sync-on-success>
			<card>
				        ...
				        <div class="tab-content">
				        	...
				        	<div class="tab-pane" id="journal-header">
				        		<journal-header
						            ...
						            invoice-header-title="Sales Order Return Journal Number"
				        	...
				        	<div class="tab-pane" id="invoice">
				        		<div class="row">
				        			<div class="form-group col-md-3">
				        			    <label>Client</label>
										<v-select disabled v-model="selected.client_id" :reduce="item => item.id" :options="clients" label="name" placeholder="Select Client"></v-select>
				        			</div>
				...
				<new-voucher
				    ...
				    :journal="journalItem"
				    :customer-or-vendor-list="customers"
				    ...
				    journal-identification="journal_number"
				    :isVendor="false"
	...
	export default {
		...
		methods: {
			...
			fetchSuccess(data) {
				...
				this.checker('Sales Order Return Journal', this.journalItem.journal_number)
