<template>
	<div>
		<form-request :submit-url="submitUrl" @load="load" @success="fetch" confirm-dialog sync-on-success>
			<card>
				<template v-slot:header>Discount Overview</template>
				...
				<div class="row">
					<div class="form-group col-sm-4">
						...
						<input type="number" step="any" class="form-control" v-model="item.discount_value" name="discount_value" :disabled="disabled">
					</div>
					<div class="form-group col-sm-4">
					...
					<div class="form-group col-sm-4">
						...
						<input type="number" step="any" class="form-control" v-model="item.from_quantity" name="from_quantity" :disabled="disabled">
					</div>
					<div class="form-group col-sm-4">
						<label>To Quantity</label>
						<input type="number" step="any" class="form-control" v-model="item.to_quantity" name="to_quantity" :disabled="disabled">
					</div>
					<div class="form-group col-sm-4">
						<label>Discount Percentage</label>
						<input type="number" step="any" class="form-control" v-model="item.discount_percentage" name="discount_percentage" :disabled="disabled">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="form-group col-sm-3">
						...
						<select class="form-control" name="discount_category" v-model="item.discount_category" :disabled="disabled">
					...
					<div class="form-group col-sm-6">
						...
						<input type="text" class="form-control" v-model="item.valid_from" name="valid_from" ref="valid_from" :disabled="disabled">
					</div>

					<div class="form-group col-sm-6">
						<label>Valid To</label>
						<input type="text" class="form-control" v-model="item.valid_to" name="valid_to" ref="valid_to" :disabled="disabled">
					</div>
					...
					<div class="form-group col-sm-3">
						<label>Vendor Discount Account</label> 
						<v-select v-model="item.main_account_id" placeholder="Select Vendor Discount Account" :options="main_accounts" :reduce="item => item.id" label="main_account_name" :disabled="disabled"></v-select>
						<input hidden v-model="item.main_account_id" name="main_account_id">
					</div>
					<div class="form-group col-sm-3">
						<label>Customer Discount Account</label> 
						<v-select v-model="item.customer_main_account_id" placeholder="Select Customer Discount Account" :options="main_accounts" :reduce="item => item.id" label="main_account_name" :disabled="disabled"></v-select>
