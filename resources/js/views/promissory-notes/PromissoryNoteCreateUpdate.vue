						...
						<div class="row">
							<div class="col-md-9">
							    <ul class="nav nav-pills">
							        ...
							        <li class="nav-item"><a class="nav-link" href="#promissory" data-toggle="tab">Promissory Note Detail</a></li>
					    	...
					    	<div class="tab-pane" id="promissory">
					    		...
					    		<div class="row">
						    		...
						    		<div class="col-sm-6">
						    			...
						    			<v-select v-model="item.vendor_bank_account_id" placeholder="Select Vendor Bank Account" :options="vendor_bank_accounts" :reduce="item => item.id" label="name"></v-select>
						    			<input hidden v-model="item.vendor_bank_account_id" name="vendor_bank_account_id">
						    		</div>
						    		<div class="col-sm-6">
