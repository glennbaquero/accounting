<template>
	<div>
		<form-request :submit-url="submitUrl" @load="load" @success="fetch" confirm-dialog sync-on-success>
			<card>
				<template v-slot:header>Vendor Payment Fee Setup Overview</template>
				...
				<div class="row">
					...
					<div class="form-group col-sm-3">
						...
						<v-select v-model="item.vendor_payment_method_id" placeholder="Select Vendor Payment Method" :options="payment_methods" :reduce="item => item.id" label="method_of_payment"></v-select>
