			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title">Select a customer first</h5>
					...
					<div class="modal-body">
						<div class="form-group col-sm-12">
							...
							<v-select :options="customers" :reduce="customer => customer.createUrl" v-model="createUrl" label="fullname" class="vue-select">
							<template #option="{ fullname, customer_account }">
								<b>Name</b> : {{ fullname }} - <b>Vendor Account</b> : {{ customer_account }}
							</template>
							</v-select>
