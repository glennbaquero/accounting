...
<!--                <td>{{ item.use_value_from }}</td>
                    <td>{{ item.report_column_name }}</td>
	...
	export default {
		...
		computed: {
			headers() {
				let array = [
				    { text: '#', value: 'id' },
                    { text: 'Dimension code', value: 'dimension_code' },
                    { text: 'Dimension name', value: 'dimension_name' },
        //             { text: 'Use Value from', value: 'use_value_from' },
				    // { text: 'Report column name', value: 'report_column_name' },
				];
