...
class CreatePurchaseOrderReturnJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_order_return_journals', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('purchase_order_return_journals');
    }
}
