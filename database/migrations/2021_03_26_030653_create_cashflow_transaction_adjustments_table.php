...
class CreateCashflowTransactionAdjustmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cashflow_transaction_adjustments', function (Blueprint $table) {
            $table->increments('id');

            $table->string('adjustment_status')->default('0')->nullable();
    ...
    {
        Schema::dropIfExists('cashflow_transaction_adjustments');
    }
}
