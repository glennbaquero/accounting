...
class CreateInvoiceApprovalJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invoice_approval_journals', function (Blueprint $table) {
            $table->increments('id');
            $table->string('invoice_approval_journal_number')->unique();
    ...
    {
        Schema::dropIfExists('invoice_approval_journals');
    }
}
