...
class CreateCustomerPaymentJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_payment_journals', function (Blueprint $table) {
            $table->increments('id');
            $table->string('customer_payment_journal_number')->unique();
    ...
    {
        Schema::dropIfExists('customer_payment_journals');
    }
}
