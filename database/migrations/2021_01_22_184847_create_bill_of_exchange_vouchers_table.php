...
class CreateBillOfExchangeVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bill_of_exchange_vouchers', function (Blueprint $table) {
            $table->increments('id');
            $table->string('invoice_voucher_number')->unique();
            $table->string('bill_exchange_journal_number');
            ...
            $table->string('customer_invoice_number')->index();
    ...
    {
        Schema::dropIfExists('bill_of_exchange_vouchers');
    }
}
