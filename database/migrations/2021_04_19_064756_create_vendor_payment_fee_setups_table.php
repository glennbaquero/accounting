...
class CreateVendorPaymentFeeSetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendor_payment_fee_setups', function (Blueprint $table) {
            $table->increments('id');
            $table->string('fee_id');
    ...
    {
        Schema::dropIfExists('vendor_payment_fee_setups');
    }
}
