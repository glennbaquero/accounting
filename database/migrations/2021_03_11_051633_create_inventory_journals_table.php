...
class CreateInventoryJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_journals', function (Blueprint $table) {
            $table->increments('id');
            $table->string('inventory_journal_number')->unique();
    ...
    {
        Schema::dropIfExists('inventory_journals');
    }
}
