...
class ProductVariationAdjustmentsCustomerInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('customer_invoices', function (Blueprint $table) {
            if (Schema::hasColumn('customer_invoices', 'cost_center')) {
                $table->dropColumn('cost_center');
            }

            if (Schema::hasColumn('customer_invoices', 'department')) {
                $table->dropColumn('department');
            }

            if (Schema::hasColumn('customer_invoices', 'expense_purpose')) {
                $table->dropColumn('expense_purpose');
            }

            if (! Schema::hasColumn('customer_invoices', 'cost_center_id')) {
                $table->integer('cost_center_id')->unsigned()->index();
            }
    
            if (! Schema::hasColumn('customer_invoices', 'department_id')) {
                $table->integer('department_id')->unsigned()->index();
            }

            if (! Schema::hasColumn('customer_invoices', 'expense_purpose_id')) {
