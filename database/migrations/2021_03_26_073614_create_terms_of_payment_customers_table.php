...
class CreateTermsOfPaymentCustomersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('terms_of_payment_customers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('terms_of_payment_customers');
    }
}
