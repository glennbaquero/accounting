...
class CreatePurchaseDeliveryReceiptLinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_delivery_receipt_lines', function (Blueprint $table) {
            $table->increments('id');
            $table->string('receipt_line_number');
            $table->string('receipt_number')->index();
            $table->string('purchase_order_line_number')->nullable();
            $table->string('purchase_order_number')->nullable();
            $table->string('product_receipt_line_number')->nullable();
    ...
    {
        Schema::dropIfExists('purchase_delivery_receipt_lines');
    }
}
