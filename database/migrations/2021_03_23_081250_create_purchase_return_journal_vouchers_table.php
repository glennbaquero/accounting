...
class CreatePurchaseReturnJournalVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_return_journal_vouchers', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('pending_vendor_invoice')->nullable();
    ...
    {
        Schema::dropIfExists('purchase_return_journal_vouchers');
    }
}
