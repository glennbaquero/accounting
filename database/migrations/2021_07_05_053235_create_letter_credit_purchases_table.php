...
class CreateLetterCreditPurchasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('letter_credit_purchases', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('letter_credit_purchases');
    }
}
