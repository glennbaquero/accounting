...
class CreateSalesReturnJournalVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_return_journal_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sales_return_journal_vouchers');
    }
}
