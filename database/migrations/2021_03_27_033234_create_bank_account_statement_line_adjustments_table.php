...
class CreateBankAccountStatementLineAdjustmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('bank_account_statement_lines', function (Blueprint $table) {
            if (!Schema::hasColumn('bank_account_statement_lines', 'bank_posting')) {
                $table->string('bank_posting')->nullable();
            }
        });

        Schema::create('bank_account_statement_line_adjustments', function (Blueprint $table) {
            $table->increments('id');
            
            // NEW COLUMNS
            $table->string('bank_statement_adjustment_id')->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('bank_account_statement_line_adjustments');
    }
}
