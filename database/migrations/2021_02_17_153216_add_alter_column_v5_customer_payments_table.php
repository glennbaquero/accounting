...
class AddAlterColumnV5CustomerPaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table(static::$tableName, function (Blueprint $table) {
            ...
            if (Schema::hasColumn(static::$tableName, 'payment_reference')) {
                $table->string('payment_reference')->nullable()->change();
            }

            if (Schema::hasColumn(static::$tableName, 'payment_specification')) {
        ...
        Schema::table(static::$tableName, function (Blueprint $table) {
            if (! Schema::hasColumn(static::$tableName, 'customer_invoice_id')) {
                $table->integer('customer_invoice_id')->nullable()->index();
            }
    ...
    public function down()
    {
        Schema::table(static::$tableName, function (Blueprint $table) {
            ...
            if (Schema::hasColumn(static::$tableName, 'payment_specification')) {
                $table->string('payment_specification')->change();
            }
            
            if (Schema::hasColumn(static::$tableName, 'customer_invoice_id')) {
                $table->integer('customer_invoice_id')->change();
            }
